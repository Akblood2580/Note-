      ...
      child: Scaffold(
          ...
          body: StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context,
                ...
                if (snapshot.hasData) {
                  snapshotData =
                      (!issearching) ? snapshot.data!.docs : snapshotData;
                        ...
                        child: InkWell(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              child: Text(
                                  "${snapshotData[index]["title"][0]}${snapshotData[index]["Description"][0]}"),
                            ),
                            title: Text(
                            ...
                            trailing: Row(
                              ...
                              children: [
                                IconButton(
                                    onPressed: () {
                                      updat(
                                          til: snapshotData[index]["title"],
                                          desc: snapshotData[index]
                                              ["Description"],
                                          tim: snapshotData[index]["Time"]);
                                    },
                                    icon: Icon(
                                      Icons.edit,
                                      color: Colors.black,
